...
./build_bootshim.sh
GCC5_AARCH64_PREFIX=aarch64-linux-gnu- build -j$(nproc --all) -s -n 0 -a AARCH64 -t GCC5 -p EXYNOS9830Pkg/Devices/x1s.dsc
cat BootShim/BootShim.bin workspace/Build/EXYNOS9830Pkg/DEBUG_GCC5/FV/EXYNOS9830PKG_UEFI.fd > workspace/UEFI
